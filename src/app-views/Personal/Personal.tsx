...
const Personal = () => {
  ...
  const menuOptions = [
    { id: '1', icon: 'person-outline', title: 'Thông tin tài khoản' },
    { id: '2', icon: 'receipt-outline', title: 'Đơn hàng', press: () => goToOrderList({ trigger: true }) },
    { id: '3', icon: 'cart-outline', title: 'Giỏ hàng', press: () => goToCart() },
    { id: '4', icon: 'location-outline', title: 'Địa chỉ' },
    { id: '5', icon: 'settings-outline', title: 'Cài đặt' },
    { id: '6', icon: 'log-out-outline', title: 'Đăng xuất', press: () => onLogout() },
  ];
